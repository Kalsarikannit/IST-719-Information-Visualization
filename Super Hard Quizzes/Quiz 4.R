...
# QUESTION 8
# 
# With respect to working with interactive visualizations, which type of interaction is the most frequent, useful and central to the analytic process?
# 
# 
# A.	
# Aggragating
...
# QUESTION 9
# 
# Suppose you work at a software company that sells many different types of games.You have access to a massive and comprehensive company sales dataset. You are asked to create a visualization showing the sale's of strategy games during the summer broken down by gender, age for each state in the U.S. and they want to particular attention placed on gender. Which visualization features would need to be supported by am interactive visualization software program? 
# 
# A.	
